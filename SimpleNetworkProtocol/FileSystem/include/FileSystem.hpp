...
protected:
    ...
    std::function<void(fuse_req_t, fuse_ino_t, size_t, off_t, fuse_file_info*)> _readDir;
    std::function<void(fuse_req_t, fuse_ino_t, size_t, off_t, fuse_file_info*)> _readDirPlus;
    // NOLINTEND
